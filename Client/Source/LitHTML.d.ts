...
declare module "https://unpkg.com/lit-html?module" {
    /**
     * @license
     ...
     */
    export const templateCaches: Map<string, Map<TemplateStringsArray, Template>>;
    /**
     ...
     * render to and update a container.
     */
    export const svg: (strings: TemplateStringsArray, ...values: any[]) => SVGTemplateResult;
    /**
     ...
     */
    export function defaultTemplateFactory(result: TemplateResult): Template;
     ...
     *     cache.
     */
    export function render(result: TemplateResult, container: Element | DocumentFragment, templateFactory?: TemplateFactory): void;
    /**
     ...
     */
    export const getValue: (part: Part, value: any) => any;
     ...
     * container.
     */
    export const reparentNodes: (container: Node, start: Node | null, end?: Node | null, before?: Node | null) => void;
    /**
     * Removes nodes, starting from `startNode` (inclusive) to `endNode`
     * (exclusive), from `container`.
     */
    export const removeNodes: (container: Node, startNode: Node | null, endNode?: Node | null) => void;
  }
